...
CATLOGO = "https://telegra.ph/file/252896167dc6a6550ce98.jpg"
...
async def inline_handler(event):  
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**iqthonbot"):
            ...
            markup = event.client.build_reply_markup(buttons)
            photo = types.InputWebDocument(
                url="https://telegra.ph/file/c4484ad9265d4491f1c01.jpg",
                size=0,
        ...
        buttons = [
            (
                Button.url("Source code", "https://github.com/Guevaras1explanations/TelethonArab-"),
                Button.url(
                    "Deploy",
